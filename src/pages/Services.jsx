  ...
  const services = [
    {
      ...
      title: t('services.hull.title') || 'Tratamento de Casco',
    ...
    },
    {
      ...
      title: t('services.paint.title') || 'Pintura & Gelcoat',
      description: t('services.paint.desc') || '',
      features: t('services.paint.features', { returnObjects: true }) || [],
      link: '/contact'
    },
    {
      icon: <Shield className="w-16 h-16" />,
      title: t('services.rigging.title') || 'Rigging Profissional',
    ...
    },
    {
      ...
      title: t('services.refit.title') || 'Refit & Reparos',
    ...
    },
    {
      ...
      title: t('services.covers.title') || 'Capas e Coberturas',
      description: t('services.covers.desc') || '',
      features: t('services.covers.features', { returnObjects: true }) || [],
      link: '/contact'
    },
    {
      icon: <CheckCircle className="w-16 h-16" />,
      title: t('services.maintenance.title') || 'Manutenção Preventiva',
    ...
    <div className="services-page">
      ...
      <section className="relative py-32 bg-gradient-to-br from-navy-900 to-ocean-600 text-white">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-5xl md:text-6xl font-bold mb-6">{t('services.page.title') || 'Nossos Serviços'}</h1>
          <p className="text-xl md:text-2xl text-gray-200 max-w-3xl mx-auto">
            {t('services.page.subtitle') || 'Oferecemos soluções completas para o seu veleiro.'}
          </p>
        </div>
      </section>
            ...
            >
              ...
              <div className="lg:w-2/3">
                <div className="bg-white p-8 rounded-xl shadow-lg">
                  ...
                  >
                    {t('services.requestQuote') || 'Solicitar Orçamento'}
      ...
      <section className="py-20 bg-navy-900 text-white text-center">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl font-bold mb-6">{t('services.cta.title') || 'Pronto para melhorar seu veleiro?'}</h2>
          <p className="text-xl mb-8 text-gray-300 max-w-2xl mx-auto">{t('services.cta.subtitle') || 'Entre em contato para solicitar um orçamento.'}</p>
          <Link
            to="/contact"
          ...
          >
            {t('services.cta.button') || 'Solicitar Orçamento'}
          </Link>
        </div>
      </section>
    </div>
