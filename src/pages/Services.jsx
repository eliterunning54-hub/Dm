  ...
  const services = [
    {
      ...
      features: t('services.items.hull.features', { returnObjects: true }), // returnObjects para pegar o array
      link: '/contact'
    },
    {
      icon: <Paintbrush className="w-16 h-16" />,
      title: t('services.items.paint.title'),
      description: t('services.items.paint.desc'),
      features: t('services.items.paint.features', { returnObjects: true }),
      link: '/contact'
    },
    {
      ...
      features: t('services.items.rigging.features', { returnObjects: true }),
      link: '/rigging'
    },
    {
      ...
      features: t('services.items.refit.features', { returnObjects: true }),
      link: '/refit'
    },
    {
      icon: <Wrench className="w-16 h-16" />,
      title: t('services.items.covers.title'),
      description: t('services.items.covers.desc'),
      features: t('services.items.covers.features', { returnObjects: true }),
      link: '/contact'
    },
    {
      icon: <CheckCircle className="w-16 h-16" />,
      title: t('services.items.maint.title'),
      description: t('services.items.maint.desc'),
      features: t('services.items.maint.features', { returnObjects: true }),
      link: '/contact'
    }
  ];
    ...
    <div className="services-page">
              ...
              <div key={index} className={`service-detail flex flex-col ${index % 2 === 0 ? 'lg:flex-row' : 'lg:flex-row-reverse'} gap-12 items-center`}>
                ...
                <div className="lg:w-2/3">
                  <div className="bg-white p-8 rounded-xl shadow-lg">
                    ...
                    <Link to={service.link} className="inline-flex items-center gap-2 bg-ocean-500 hover:bg-ocean-600 text-white px-6 py-3 rounded-lg font-semibold transition-all">
      ...
      <section className="py-20 bg-navy-900 text-white text-center">
        <div className="container mx-auto px-4">
          ...
          <Link to="/contact" className="inline-block bg-ocean-500 hover:bg-ocean-600 text-white px-8 py-4 rounded-lg font-semibold text-lg transition-all transform hover:scale-105">
